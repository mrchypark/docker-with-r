...
vmware
vm과 차이점
문제는 toolbox로는 혜택을 받지는 못함

git이 저장을 종단에서 횡단으로 하는 것을 지원한다면,
docker는 OS 수준의 저장과 실행을 지원

그게 왜 필요하냐. 우선 konlp 설치 힘들었던 사람 손
이미 설치되어 있는걸 쓰면 됨!
...
`Rstudio`가 1.1 버전부터 몇 가지 유용한 기능을 추가로 제공하기 시작했습니다. 그래서 이후 안정화 버전이 나오더라도 계속 사용할 기능들을 소개하려고 합니다. 실습을 위한 다운로드 링크[[바로가기](https://www.rstudio.com/products/rstudio/download/#download)]에 들어가 각자의 OS에 맞는 버전을 다운 받아 설치해 주세요.

.left[
  ![](https://raw.githubusercontent.com/mrchypark/github-with-rstudio/master/docs/img/rstudio-download.png)
]
---
...
1. <https://github.com/자신의계정/github-with-rstudio> 주소를 복사합니다.
1. Rstudio에서 File > New project > version control > Git 으로 이동합니다.
1. Repository Url 에 2.에서 복사한 주소를 붙여넣습니다.
1. 저장소 이름의 폴더가 생성될 경로를 설정합니다.
1. Create project 버튼을 누릅니다.
